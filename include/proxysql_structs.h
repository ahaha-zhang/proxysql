...
__thread int mysql_thread___max_concurrency;
__thread int mysql_thread___thread_running_tickets;
__thread int mysql_thread___max_concurrency_sleep_us;
...
extern __thread int mysql_thread___max_concurrency;
extern __thread int mysql_thread___thread_running_tickets;
extern __thread int mysql_thread___max_concurrency_sleep_us;
